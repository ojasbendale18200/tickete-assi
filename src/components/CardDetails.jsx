...
function CardDetails() {
  return (
    ...
    //       <Input type="number" placeholder="6/26" w={"384px"} h={"60px"} />
    //     </FormControl>
    //     <FormControl>
    //       <FormLabel color={"#595959"}>CVV/CVC</FormLabel>
    //       <Input type="password" placeholder="***" w={"384px"} h={"60px"} />
    //     </FormControl>
    //   </Grid>
    //   <Divider w={"792px"} h={"1px"} backgroundColor={"#D6D6D6"} />
    //   <Flex alignItems="center" gap="10px">
    //     <svg
    //       xmlns="http://www.w3.org/2000/svg"
    //       width="35"
    ...
    >
      ...
      <Box display={"inline-flex"} flexDirection={"column"} gap={"12px"}>
        <Text
          fontSize={"12px"}
          fontWeight={"400"}
          lineHeight={"20px"}
        ...
        >
          ...
          <Text color={"#1733B6"}>terms and conditions of Tickete</Text> & the
          <Text color={"#1733B6"}>activity provider.</Text>
        </Text>
      </Box>
      <Box
        display={"flex"}
      ...
      <Text fontSize="12px" fontWeight="400" lineHeight="20px" color="#595959">
        With payment, you agree to the general
